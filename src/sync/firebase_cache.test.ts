...
import {
    ...
    type LatestNotesSchemaWithoutData
...
describe("FirebaseCache", () => {
    ...
    describe("writeToFirebaseCache", () => {
        const mockCloudData: SchemaWithId<LatestNotesSchema | LatestNotesSchemaWithoutData>[] = [
            {
                id: "id1",
                data: {
                    path: "file1.md",
            ...
            },
            {
                ...
                data: {
                    path: "file2.md",
                    entryTime: 2000
                } as unknown as LatestNotesSchemaWithoutData
            }
        ];

        const expectedCacheData: FirebaseStoredData<SchemaWithId<LatestNotesSchemaWithoutData>> = {
            lastUpdate: 2000,
            cache: [
                {
                    id: "id1",
