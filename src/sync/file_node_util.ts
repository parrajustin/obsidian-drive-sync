...
//     @Span()
//     @PromiseResultSpanError
//     public static async GetLocalFileNode(
//         app: App,
//         config: LatestSyncConfigVersion,
...
//             return this.GetRawNode(app, config, fullPath);
//         }
//         if (IsAcceptablePath(fullPath, config) && IsObsidianFile(fullPath, config)) {
//             return this.GetObsidianNode(app, config, fullPath);
//         }
...
//     @Span()
//     @PromiseResultSpanError
//     public static async UpdateLocalFileMapWithLocalChanges(
//         app: App,
//         config: LatestSyncConfigVersion,
...
//         const filesByFilePath = this.MapByFilePath(this.FlattenFileNodes(fileMap));
//         const changedPathResult = CombineResults(
//             await Promise.all(
//                 AsyncForEach(
//                     [...changedPath],
//                     async (path: FilePathType): Promise<StatusResult<StatusError>> => {
//                         if (!this.IsFilePathValid(config, path)) {
//                             return Ok();
//                         }
...
//                         const newNodeResult = await this.GetLocalFileNode(app, config, path);
...
//         const map = this.ConvertArrayOfNodesToMap([...filesByFilePath.entries()].map((n) => n[1]));
//         return map.mapErr((e) => e.setPayload("label", "return"));
//     }

//     /** Filters file nodes to make sure they should be kept. */
//     @Span()
//     public static FilterFileNodes<TypeOfData extends ImmutableBaseFileNode = AllFileNodeTypes>(
//         config: LatestSyncConfigVersion,
//         nodes: TypeOfData[]
//     ): TypeOfData[] {
//         return nodes.filter(
...
//                     const fileResult = await this.GetObsidianNode(app, config, fullPath);
//                     if (fileResult.err) {
//                         return fileResult;
//                     }
...
//                     const fileResult = await this.GetRawNode(app, config, fullPath);
//                     if (fileResult.err) {
//                         return fileResult;
//                     }
//                     const optFile = fileResult.safeUnwrap();
...
//     @Span()
//     @ResultSpanError
//     public static ConvertArrayOfNodesToMap<
...
//             } else {
//                 return Err(
//                     InternalError(`Found a folder at final path for "${node.data.fullPath}".`)
//                 );
//             }
//         }
...
//     @Span()
//     @PromiseResultSpanError
//     public static async GetFileMapOfNodes(
//         app: App,
//         config: LatestSyncConfigVersion
//     ): Promise<Result<FileMapOfNodes<LocalNode>, StatusError>> {
//         const fileNodesResult = await this.GetAllFileNodes(app, config);
//         if (fileNodesResult.err) {
//             return fileNodesResult;
//         }
//         return this.ConvertArrayOfNodesToMap(fileNodesResult.safeUnwrap());
//     }

//     /** Flattens the file map to get the array of file nodes. */
//     @Span()
//     public static FlattenFileNodes<TypeOfData extends ImmutableBaseFileNode = AllFileNodeTypes>(
...
//     @Span()
//     public static MapByFilePath<TypeOfData extends ImmutableBaseFileNode = AllFileNodeTypes>(
//         arry: TypeOfData[]
...
//     @Span()
//     @ResultSpanError
//     public static GetNonDeletedByFilePath<
//         TypeOfData extends ImmutableBaseFileNode = AllFileNodeTypes
//     >(
//         fileMap: FileMapOfNodes<TypeOfData>,
//         filePath: string
//     ): Result<Option<TypeOfData>, StatusError> {
...
//     @Span()
//     private static IsFilePathValid(config: LatestSyncConfigVersion, fullPath: FilePathType) {
//         return (
